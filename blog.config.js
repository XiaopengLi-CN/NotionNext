...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xiaopeng Li', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '主页学编程，副业学厨师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hse.email', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '2024技术学习博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://xiaopengli.me', // 你的微博个人主页
